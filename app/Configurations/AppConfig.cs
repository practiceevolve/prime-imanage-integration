namespace PE.Mk2.Integrations.IManage.Configurations
{
    ...
    public class TenantConfig
    {
        ...
        /// </summary>
        public IManageConfig IManage { get; set; }
    ...
    public class IManageConfig
    {
        public required string ApiUrl { get; set; } = "https://cloudimanage.com";
        public required string OAuthTokenUrl { get; set; } = "https://cloudimanage.com/auth/oauth2/token";
        ...
        public required string DefaultFolderName { get; set; }
    }
